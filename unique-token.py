...
def main():
    ...
    tokenizer.add_tokens([f"<note{i},duration{j},gap{k}>" for i in range(len(MIDI_NOTES)) for j in range(len(DURATIONS)) for k in range(len(GAPS))])
